...
if __name__ == "__main__":
    ...
    all_commands = ""
    for dataset_dir in ['expert_perfect/no_aug', 'expert_prefect/aug_uniform']:
        for dataset_size in [10, 50, 100]:

            name = f"ExpPerfect_{dataset_dir.replace('/', '_')}_{dataset_size}k"
    ...
    f = open(f'{save_dir}/expert_perfect.txt', "w",)

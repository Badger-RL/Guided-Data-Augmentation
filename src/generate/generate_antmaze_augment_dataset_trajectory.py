...
timestamps = {
    'antmaze-umaze-diverse-v1': {
        'start': [560, 1135, 1181, 1570, 1620, 3185, 3216, 5000, 5108, 5140, 5190, 5300, 5400],
        'end':   [598, 1180, 1240, 1620, 1650, 3215, 3290, 5100, 5140, 5190, 5300, 5400, 5500],
        'n': int(1e6),
        "direction": [3, 1, 2, 3, 0, 1, 2, 0, 2, 3, 0, 0, 0],

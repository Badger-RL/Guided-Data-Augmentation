...
def main():
    ...
    for i in range(0,50):
        log_file = f'physical_data_clean/scoring2/trajectories_3_{i}.log'
        log_file = f'guda/trajectories_3_{i}.log'
        log_file = f'physical_data_clean/scoring_clean_6/trajectories_3_{i}.log'

...
def main():
    ...
    parser.add_argument('--num_samples', type=int, default=int(1e3), help='Num samples to collect')
    ...
    parser.set_defaults(use_policy=True)
    ...
    fname = f'../datasets/{"expert" if args.random_actions else "random"}/{args.num_samples}.hdf5'

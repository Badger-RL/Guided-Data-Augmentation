...
dataset = {}
data_hdf5 = h5py.File('../../datasets/PushBallToGoal-v2/physical/guided_traj.hdf5', "r")
...
actor = algorithms.awac.Actor(
    state_dim, action_dim, max_action=max_action, hidden_dim=128, n_layers=2,
).to("cpu")

path = '/Users/nicholascorrado/code/offlinerl/GuidedDataAugmentationForRobotics/src/plotting/physical/physical_awac/results/PushBallToGoal-v2/no_aug/awac/nl_2/hd_128/lr_3e-05/l_2/run_0/model.pt'
path = '/Users/nicholascorrado/code/offlinerl/GuidedDataAugmentationForRobotics/src/plotting/physical/physical_awac/results/PushBallToGoal-v2/guided_traj/awac/nl_2/hd_128/lr_3e-05/l_2/run_0/model.pt'

...
if __name__ == "__main__":
    ...
    save_dir = './buffers'
    np.save(f'{save_dir}/Default_{args.env_id}_0_state.npy', data['observations'])
    np.save(f'{save_dir}/Default_{args.env_id}_0_action.npy', data['actions'].reshape(-1, 1))
    np.save(f'{save_dir}/Default_{args.env_id}_0_reward.npy', data['rewards'].reshape(-1, 1))
    np.save(f'{save_dir}/Default_{args.env_id}_0_next_state.npy', data['next_observations'])
    np.save(f'{save_dir}/Default_{args.env_id}_0_not_done.npy', (1-data['terminals'].reshape(-1, 1)))
